 ...
 */
export async function setUserInSession(
  req: express.Request,
  gristServer: GristServer,
  profile: UserProfile
) {
  const scopedSession = gristServer
    .getSessions()
...
export function createDummyGristServer(): GristServer {
  return {
    ...
    getHomeUrl() {
      return "http://0.0.0.0:4242";
    },
    getHomeUrlByDocId() {
      return Promise.resolve("http://0.0.0.0:4242");
    },
    getMergedOrgUrl() {
      return "http://0.0.0.0:4242";
    },
    ...
    getPermitStore() {
      throw new Error("no permit store");
    },
    getExternalPermitStore() {
      throw new Error("no external permit store");
    },
    getGristConfig() {
      return { homeUrl: "", timestampMs: 0 };
    },
    getOrgUrl() {
    ...
    getInstallAdmin() {
      throw new Error("no install admin");
    },
    getHomeDBManager() {
    ...
    getDocTemplate() {
      throw new Error("no doc template");
    },
    getTag() {
      return "tag";
    },
    ...
    getAccessTokens() {
      throw new Error("no access tokens");
    },
    resolveLoginSystem() {
      throw new Error("no login system");
    },
    getPluginUrl() {
      return undefined;
    },
